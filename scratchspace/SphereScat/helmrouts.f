...
c
c      HPOTFLD3DALL_DP:  direct calculation for a collection of charge sources
c      HPOTFLD3D_DP : direct calculation for a single charge source
c
c**********************************************************************
...
c**********************************************************************
     ...
     1		ztarg,pot,iffld,fld,w,lw,lused,ier)
c**********************************************************************
c
...
c----------------------------------------------------------------------
      implicit real *8 (a-h,o-z)
      integer ns
      real *8 sources(3,ns),center(3),w(1)
...
c
     ...
     1		center,nterms,locexp,w,lw,lused)
      enddo
c
c     scale by (i*k)
c
...
C***********************************************************************
     ...
     1                  center,nterms,mpole,w,lw,lused)
C***********************************************************************
C
...
c
     ...
     1        dipvec(1,i),center,nterms,mpole,w,lw,lused)
      enddo
c
      do l = 0,nterms
         do m=-l,l
...
c
     ...
     1		dipvec(1,i),center,nterms,locexp,w,lw,lused)
      enddo
c
c     scale by (i*k)
c
...
c**********************************************************************
     ...
     &		center,nterms,locexp,w,lw,lused)
c**********************************************************************
c
c     This subroutine creates the local expansion about CENTER
